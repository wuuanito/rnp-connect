...
@Component({
  selector: 'app-layout-internacional',
  standalone: true,
  imports: [RouterOutlet,RouterLink,AppNotificationComponent],
  templateUrl: './layout-internacional.component.html',
  styleUrl: './layout-internacional.component.css'
})
export class LayoutInternacionalComponent implements OnInit, OnDestroy {
