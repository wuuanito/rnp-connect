...
@Component({
  selector: 'app-solicitudes-rrhh',
  standalone: true,
  imports: [CommonModule, FormsModule,NgxPaginationModule],
  templateUrl: './solicitudes-rrhh.component.html',
  styleUrl: './solicitudes-rrhh.component.css'
})
export class SolicitudesRrhhComponent implements OnInit, OnDestroy {
  ...
  departamentoActual: number = 8; // Asume que el departamento actual es 2 (Compras) por defecto
