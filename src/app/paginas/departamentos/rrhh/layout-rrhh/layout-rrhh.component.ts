...
@Component({
  selector: 'app-layout-rrhh',
  standalone: true,
  imports: [RouterOutlet,RouterLink,AppNotificationComponent],
  templateUrl: './layout-rrhh.component.html',
  styleUrl: './layout-rrhh.component.css'
})
export class LayoutRrhhComponent implements OnInit, OnDestroy {
