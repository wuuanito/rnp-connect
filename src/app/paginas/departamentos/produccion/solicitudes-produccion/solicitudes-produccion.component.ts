...
@Component({
  selector: 'app-solicitudes-produccion',
  standalone: true,
  imports: [CommonModule, FormsModule,NgxPaginationModule],
  templateUrl: './solicitudes-produccion.component.html',
  styleUrl: './solicitudes-produccion.component.css'
})
export class SolicitudesProduccionComponent implements OnInit, OnDestroy {
  ...
  departamentoActual: number = 10; // Asume que el departamento actual es 2 (Compras) por defecto
