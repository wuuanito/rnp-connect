...
@Component({
  selector: 'app-layout-gerencia',
  standalone: true,
  imports: [RouterOutlet,RouterLink,AppNotificationComponent],
  templateUrl: './layout-gerencia.component.html',
  styleUrl: './layout-gerencia.component.css'
})
export class LayoutGerenciaComponent implements OnInit, OnDestroy {
