...
@Component({
  ...
  templateUrl: './solicitudes-gerencia.component.html',
  styleUrl: './solicitudes-gerencia.component.css'
})
export class SolicitudesGerenciaComponent implements OnInit, OnDestroy {
  ...
  departamentoActual: number = 3; // Asume que el departamento actual es 2 (Compras) por defecto
