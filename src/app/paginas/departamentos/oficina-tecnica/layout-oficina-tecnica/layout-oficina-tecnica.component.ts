...
@Component({
  selector: 'app-layout-oficina-tecnica',
  standalone: true,
  imports: [RouterOutlet,RouterLink,AppNotificationComponent],
  templateUrl: './layout-oficina-tecnica.component.html',
  styleUrl: './layout-oficina-tecnica.component.css'
})
export class LayoutOficinaTecnicaComponent implements OnInit, OnDestroy {
