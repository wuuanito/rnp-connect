...
@Component({
  selector: 'app-solicitudes-oficina-tecnica',
  standalone: true,
  imports: [CommonModule, FormsModule,NgxPaginationModule],
  templateUrl: './solicitudes-oficina-tecnica.component.html',
  styleUrl: './solicitudes-oficina-tecnica.component.css'
})
export class SolicitudesOficinaTecnicaComponent implements OnInit, OnDestroy {
  ...
  departamentoActual: number = 7; // Asume que el departamento actual es 2 (Compras) por defecto
