...
@Component({
  ...
  templateUrl: './layout-mantenimiento.component.html',
  styleUrl: './layout-mantenimiento.component.css'
})
export class LayoutMantenimientoComponent implements OnInit, OnDestroy {
