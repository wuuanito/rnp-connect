...
@Component({
  selector: 'app-solicitudes-manteniminento',
  standalone: true,
  imports: [CommonModule, FormsModule,NgxPaginationModule],
  templateUrl: './solicitudes-manteniminento.component.html',
  styleUrl: './solicitudes-manteniminento.component.css'
})
export class SolicitudesManteniminentoComponent implements OnInit, OnDestroy {
  ...
  departamentoActual: number = 6; // Asume que el departamento actual es 2 (Compras) por defecto
