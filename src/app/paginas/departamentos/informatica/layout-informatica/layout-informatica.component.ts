...
@Component({
  selector: 'app-layout-informatica',
  standalone: true,
  imports: [RouterOutlet,RouterLink,AppNotificationComponent],
  templateUrl: './layout-informatica.component.html',
  styleUrl: './layout-informatica.component.css'
})
export class LayoutInformaticaComponent implements OnInit, OnDestroy {
