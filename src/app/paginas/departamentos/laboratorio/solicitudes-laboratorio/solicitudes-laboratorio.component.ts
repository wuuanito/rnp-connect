...
@Component({
  selector: 'app-solicitudes-laboratorio',
  standalone: true,
  imports: [CommonModule, FormsModule,NgxPaginationModule],
  templateUrl: './solicitudes-laboratorio.component.html',
  styleUrl: './solicitudes-laboratorio.component.css'
})
export class SolicitudesLaboratorioComponent implements OnInit, OnDestroy {
  ...
  departamentoActual: number = 9; // Asume que el departamento actual es 2 (Compras) por defecto
