...
import { SolicitudDetallesComponent } from './solicitud-detalles/solicitud-detalles.component';
...
@Component({
  selector: 'app-ver-materias-primas-almacen',
  standalone: true,
  imports: [
    CommonModule,
    MatTableModule,
  ...
  templateUrl: './ver-materias-primas-almacen.component.html',
  styleUrls: ['./ver-materias-primas-almacen.component.css'],
})
export class VerMateriasPrimasAlmacenComponent implements OnInit {
  displayedColumns = ['fechaSolicitud', 'personaSolicita', 'nombreMateria', 'codigo', 'lote', 'proveedor', 'ubicacion', 'urgencia', 'estado', 'ver',];
