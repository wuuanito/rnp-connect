...
@Component({
  selector: 'app-solicitudes-adminsitracion',
  standalone: true,
  imports: [CommonModule, FormsModule,NgxPaginationModule],
  templateUrl: './solicitudes-adminsitracion.component.html',
  styleUrl: './solicitudes-adminsitracion.component.css'
})
export class SolicitudesAdminsitracionComponent implements OnInit, OnDestroy {
  ...
  departamentoActual: number = 4; // Asume que el departamento actual es 2 (Compras) por defecto
